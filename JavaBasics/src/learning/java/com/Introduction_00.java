...
public class Introduction {
     ...
     * It was initiated by a bunch of people, the most prominent among them was James Gosling.
     *
     ...
     * In Java, the compiler converts the source code (.java source files) to an intermediate format called byte code
     ...
     * Java does few things to optimize processing. One of them is Just-in-time (JIT) compiler of java.
     * When JVM detects a piece of code that has to be run multiple number of times, it will convert that piece of code into machine
     * level code and run it to optimize performance.
     *
     ...
     *    java-9 only.
     *
     * Five goals java was designed to meet
     ...
     *
     * Installing JDK
     * The Best way to install jdk is from openjdk.org. Other versions like the oracle have licensing requirements.
     *
     * Refer to the below link to learn more about C1 and C2 compilers of the JVM:
